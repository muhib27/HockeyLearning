...
import com.khelbeibangladesh.activity.MainActivity;
import com.khelbeibangladesh.utils.LocalFileUncaughtExceptionHandler;
...
// The first in the list of RunningTasks is always the foreground task.
        ...
        if (topActivityRun.equals("ComponentInfo{com.sports333/com.sports333.activity.MainActivity}"))
...
//            notificationIntent.putExtra("target_id", id);
            ...
            NotificationCompat.Builder mNotifyBuilder = new NotificationCompat.Builder(mInstance, NOTIFICATION_CHANNEL_ID)
                    .setSmallIcon(R.drawable.notification_icon)
                    .setColor(ContextCompat.getColor(context, R.color.noti_bg))
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                ...
                NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Sports", importance);

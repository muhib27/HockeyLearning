package com.khelbeibangladesh.activity;
...
import com.khelbeibangladesh.R;
import com.khelbeibangladesh.utils.AppSharedPreference;
...
public class FcmViewActivity extends AppCompatActivity {
        ...
        asw_view.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                if (!check_permission(2)) {
                    ActivityCompat.requestPermissions(FcmViewActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, file_perm);
                } else {
                ...
                if (check_permission(2) && check_permission(3)) {
                    if (ASWP_FUPLOAD) {
                        ...
                        if (ASWP_CAMUPLOAD) {
                            ...
                            if (takePictureIntent.resolveActivity(FcmViewActivity.this.getPackageManager()) != null) {
                                File photoFile = null;
                                try {
...
//        }
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            FcmViewActivity.this.setTaskDescription(taskDesc);
        }
        //get_location();
    }
...
//			url += "rid=" + random_id();
    ...
    public boolean url_actions(WebView view, String url) {
        ...
        if (!ASWP_OFFLINE && !DetectConnection.isInternetAvailable(FcmViewActivity.this)) {
...
//		}
    ...
    public void get_file() {
        ...
        if (ASWP_FUPLOAD && ASWP_CAMUPLOAD && !check_permission(2) && !check_permission(3)) {
            ActivityCompat.requestPermissions(FcmViewActivity.this, perms, file_perm);
            ...
            ActivityCompat.requestPermissions(FcmViewActivity.this, new String[]{Manifest.permission.CAMERA}, file_perm);
        }
    }
